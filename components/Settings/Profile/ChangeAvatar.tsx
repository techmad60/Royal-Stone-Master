...
export default function ChangeAvatar({ onClose }: ProfilePictureInfoProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (uploadResponse.ok) {
        ...
        setTimeout(() => {
          onClose(); // Close the modal before reloading the page
          setTimeout(() => {
            window.location.reload();
          }, 100); // Add slight delay to ensure smooth transition
        }, 2000);
      } else {
      ...
      <div className="flex flex-col bg-white rounded-t-[15px] w-full h-[490px] sm:h-[580px] lg:rounded-[20px] lg:max-w-[621px] lg:h-auto">
        ...
        <div className="flex flex-col p-4 sm:p-8 lg:p-4">
          <section className="mt-8">
            <p className="text-color-form text-sm">Provide a profile picture</p>
            <div
